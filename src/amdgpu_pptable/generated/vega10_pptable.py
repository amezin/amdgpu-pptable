# -*- coding: utf-8 -*-
#
# TARGET arch is: ['-include', 'stdint.h', '-include', '/home/amezin/linux/drivers/gpu/drm/amd/include/atom-types.h', '-include', '/home/amezin/linux/drivers/gpu/drm/amd/include/atomfirmware.h']
# WORD_SIZE is: 8
# POINTER_SIZE is: 8
...
class struct__ATOM_Vega10_POWERPLAYTABLE(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_State(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_State_Array(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_CLK_Dependency_Record(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_GFXCLK_Dependency_Record(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ulClk', ctypes.c_uint32),
    ('ucVddInd', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_GFXCLK_Dependency_Record_V2(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ulClk', ctypes.c_uint32),
    ('ucVddInd', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_MCLK_Dependency_Record(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_GFXCLK_Dependency_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_MCLK_Dependency_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_SOCCLK_Dependency_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_DCEFCLK_Dependency_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_PIXCLK_Dependency_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_DISPCLK_Dependency_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_PHYCLK_Dependency_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_MM_Dependency_Record(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_MM_Dependency_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_PCIE_Record(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_PCIE_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_Voltage_Lookup_Record(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_Voltage_Lookup_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_Fan_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_Fan_Table_V2(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('usFanOutputSensitivity', ctypes.c_uint16),
...
class struct__ATOM_Vega10_VCE_State_Record(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_VCE_State_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_PowerTune_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
...
class struct__ATOM_Vega10_PowerTune_Table_V2(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('usSocketPowerLimit', ctypes.c_uint16),
...
class struct__ATOM_Vega10_PowerTune_Table_V3(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('usSocketPowerLimit', ctypes.c_uint16),
...
class struct__ATOM_Vega10_Hard_Limit_Record(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
...
class struct__ATOM_Vega10_Hard_Limit_Table(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
    ('ucNumEntries', ctypes.c_ubyte),
...
class struct__Vega10_PPTable_Generic_SubTable_Header(ctypes.LittleEndianStructure):
    _pack_ = True # source:False
    _fields_ = [
    ('ucRevId', ctypes.c_ubyte),
     ]
...
__all__ =\
    ...
    'struct__ATOM_Vega10_State', 'ATOM_Vega10_MM_Dependency_Record',
    ...
    'ATOM_Vega10_PowerTune_Table_V2', 'ATOM_Vega10_Fan_Table_V2',
    ...
    'ATOM_Vega10_Hard_Limit_Record', 'struct__ATOM_Vega10_Fan_Table',
    'ATOM_Vega10_PCIE_Table',
    'struct__ATOM_Vega10_DCEFCLK_Dependency_Table',
    'struct__ATOM_Vega10_PCIE_Record', 'ATOM_Vega10_PCIE_Record',
    ...
    'ATOM_Vega10_CLK_Dependency_Record', 'ATOM_Vega10_State',
    'struct__ATOM_Vega10_State_Array', 'ATOM_Vega10_Hard_Limit_Table',
    'struct__ATOM_Vega10_CLK_Dependency_Record',
    'ATOM_Vega10_Voltage_Lookup_Record', 'ATOM_Vega10_State_Array',
    ...
    'ATOM_Vega10_VCE_State_Table', 'struct_atom_common_table_header',
    'ATOM_Vega10_GFXCLK_Dependency_Record',
    'struct__ATOM_Vega10_DISPCLK_Dependency_Table',
    'ATOM_Vega10_POWERPLAYTABLE', 'ATOM_Vega10_Fan_Table',
